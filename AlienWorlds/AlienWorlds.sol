...
contract TeleportToken is ERC20Interface, Owned, Oracled, Verify {
    ...
    function transfer(address to, uint tokens) override public returns (bool success) {
        // require(msg.sender != to, "Sender and receipient should not be the same address!");
    ...
    function transferFrom(address from, address to, uint tokens) override public returns (bool success) {
        // require(from != to, "Sender and receipient should not be the same address!");
    ...
    function teleport(string memory to, uint tokens, uint chainid) public returns (bool success) {
        require(to != address(0), "ERC20: zero address spender");
        balances[msg.sender] = balances[msg.sender].sub(tokens);
